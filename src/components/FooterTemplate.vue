...
<template>
  <footer class="flex flex-col items-center justify-center" id="contacts">
    <div class="w-full flex items-center justify-center gap-20 p-5 bg-white rounded-lg shadow-lg">
      <div class="w-[30%] flex items-center gap-5 m-auto">
        <MapPin :color="'red'" :size="35" class="icon" />

        <div class="flex flex-col items-start">
          <p class="font-bold">Адрес</p>

          <a class="w-full" href="https://yandex.ru/maps/?l=map&text=г.%20Йошкар-Ола,%20ул.%20Ленина,%20д.%201г"
            target="_blank">
