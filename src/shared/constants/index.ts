...
export const services: Service[] = [
  ...
  },
  {
    ...
    description:
      '<span class="font-bold italic">Личная безопасность</span> - широкий комплекс мер, которые направлены на защиту жизни и здоровья человека. В это понятие включены меры по предотвращению, выявлению и нейтрализации рисков, а также по устранению их последствий.',
    icon: User,
    iconAnim: UserRound
  },
  {
