...
export const services: Service[] = [
  {
    ...
    description:
      'Пришел. Изучил. Изменил. Сэкономил.</br>- Обеспечение устойчивости предприятия, предотвращение хищений, мошенничества и утечек информации;<br/>- Оценка угроз, разработка мер по снижению рисков;<br/>- Взаимодействие с правоохранительными органами, защита данных, контроль финансов, обеспечение прозрачности сделок, защита активов;<br/>- Mониторинг законодательства и рынка;<br/> - Консультирование по экономической безопасности.<br/>',
    icon: Coins,
    iconAnim: HandCoins
  },
  {
  ...
  },
  {
    ...
    description:
      'Важные инструменты для контроля и мониторинга транспорта и помещений. Они позволяют отслеживать местоположение, контролировать рабочее время водителей и предотвращать нарушения законодательства, что улучшает эффективность работы и снижает затраты.',
    icon: MapPinHouse,
    iconAnim: HousePlus
  },
  {
...
export const sections: Service[] = [
  ...
  },
  {
    ...
    description:
      'Гарантированная помощь по защите прав в любой ситуации. Особенно остро такие вопросы встают перед владельцами бизнеса.<br/>Сопровождение в суде.',
    icon: UserPen
  }
];
...
export const servicesFiz: Service[] = [
  {
    ...
    description:
      'Проведение детального расследование, позволяющее получить факты и доказательства, чтобы разрешить сомнения и принять взвешенные решения по личным и семейным вопросам.',
    icon: HeartCrack
  },
  {
    title: 'Проверка и отбор домашнего персонала',
    description:
      'Доверие к тем, кто окружает вас и вашу семью. Тщательная проверка кандидатов на домашние должности, чтобы вы могли быть уверены в их честности и квалификации.',
    icon: HousePlus
  },
  {
