...
export const sections: Service[] = [
  ...
  },
  {
    ...
    description:
      '<span class="font-bold italic">Юридические консультации</span> - гарантированная помощь по защите прав в любой ситуации. Особенно остро такие вопросы встают перед владельцами бизнеса.<br/>Сопровождение в суде.',
    icon: UserPen
  }
];
...
export const servicesFiz: Service[] = [
  ...
  },
  {
    ...
    description:
      'Безопасность в доме — это доверие к тем, кто окружает вас и вашу семью. Тщательная проверка кандидатов на домашние должности, чтобы вы могли быть уверены в их честности и квалификации.',
    icon: HousePlus
  },
  {
